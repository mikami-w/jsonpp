...
class Amalgamator:
    ...
    def _compose_output(self) -> str:
        out: list[str] = []
        out.append("/*\n")
        out.append("jsonpp - JSON for Modern C++\n")
        out.append("https://github.com/mikami-w/jsonpp\n\n")
        out.append("This file is auto-generated by scripts/generate_single_include.py\n")
